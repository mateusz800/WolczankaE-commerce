...
class __TwigTemplate_a937fe5b7296a548a59070e262e034e147da6ab85231f6377e440477f596566a extends \Twig\Template
{
...
";
    ...
    public function block_keyword($context, array $blocks = [])
    {
        ...
        // line 27
        echo "  ";
        if ($this->getAttribute((isset($context["routeKeywords"]) ? $context["routeKeywords"] : null), (isset($context["idRoute"]) ? $context["idRoute"] : $this->getContext($context, "idRoute")), [], "array", true, true)) {
            // line 28
            echo "    ";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["routeKeywords"]) ? $context["routeKeywords"] : $this->getContext($context, "routeKeywords")), (isset($context["idRoute"]) ? $context["idRoute"] : $this->getContext($context, "idRoute")), [], "array"));
      ...
      ";
                // line 34
                $context["formattedKeywords"] = twig_array_merge((isset($context["formattedKeywords"]) ? $context["formattedKeywords"] : $this->getContext($context, "formattedKeywords")), [0 => (isset($context["formattedKeyword"]) ? $context["formattedKeyword"] : $this->getContext($context, "formattedKeyword"))]);
                // line 35
                echo "    ";
            }
    ...
    ";
            // line 37
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Keywords: %keywords%", ["%keywords%" => twig_join_filter((isset($context["formattedKeywords"]) ? $context["formattedKeywords"] : $this->getContext($context, "formattedKeywords")), ", ")], "Admin.Shopparameters.Feature"), "html", null, true);
            echo "
  ";
        }
